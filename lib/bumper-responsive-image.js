...
(function() {
  (function(root, factory) {
    ...
    BumperResponsiveImage = (function() {
      ...
      BumperResponsiveImage.prototype.options = {
      ...
      BumperResponsiveImage.prototype.getUrl = function(el, breakpoint) {
        ...
        if ((window.Bumper.Dom != null) && fullUrl.indexOf('{') >= 0) {
          fullUrl = window.Bumper.Dom.interpolateElementAttrs(fullUrl, el, this.options.restrictToParents);
        }
        return fullUrl;
      };
