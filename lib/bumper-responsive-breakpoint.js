    ...
    BumperResponsiveBreakpoint = (function() {
      ...
      BumperResponsiveBreakpoint.prototype.setBreakpoints = function(breakpoints) {
        ...
        if (typeof breakpoints !== 'object') {
          return console.warn('breakpoints must be an object');
        }
        for (name in breakpoints) {
          data = breakpoints[name];
          if (data.min === void 0) {
            return console.warn("breakpoint " + name + " must have a min value");
          }
          if (data.max === void 0) {
            return console.warn("breakpoint " + name + " must have a max value");
          }
        }
      ...
      BumperResponsiveBreakpoint.prototype.setCurrentFunction = function(func) {
        if (typeof func !== 'function') {
          return console.warn('Must be a function!');
        }
