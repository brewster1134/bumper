...
(function() {
  ...
  (function(factory) {
    if (typeof define !== "undefined" && define !== null ? define.amd : void 0) {
      return define(['bumper-core'], function(Core) {
        return factory(Core);
      });
    } else {
      return factory(window.Bumper.Core);
    }
  })(function(Core) {
    var BumperResponsiveBreakpoint, base, base1;
    BumperResponsiveBreakpoint = (function(superClass) {
      extend(BumperResponsiveBreakpoint, superClass);

      function BumperResponsiveBreakpoint() {
        return BumperResponsiveBreakpoint.__super__.constructor.apply(this, arguments);
      }
    ...
    return (base1 = window.Bumper.Responsive).Breakpoint || (base1.Breakpoint = new BumperResponsiveBreakpoint);
  });
